...
(let ()
  ...
  (define (main)
    (let* ((result*delta1 (timeit fib10))
           (result*delta2 (timeit fib20))
           (result*delta3 (timeit fib30))
           (result*delta4 (timeit fib40))
           (result*delta5 (timeit fib41))
           (result*delta6 (timeit fib42)))
